...
public class Loans extends BaseEntity {
    ...
    public Loans(Long loanId, String mobileNumber, String loanNumber, String loanType, BigInteger totalLoan, BigInteger amountPaid, BigInteger outstandingAmount) {
        this.loanId = loanId;
